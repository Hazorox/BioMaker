  ...
  return (
    <>
      ...
      <div className={" h-screen flex   items-center justify-center overflow-auto"}>
        {/* Hidden Bio Card */}
      <div className={(showFullBio?"visible ":"hidden ")+transparent +
        ...
        <FaXmark color="black" cursor={'pointer'} size={35} onClick={toggleBioVisibility} className="absolute top-[10px] right-[10px]" />
      </div>
        {/*transparent card*/}
        <div
          className={(showFullBio?"hidden ":"visible ")+
            transparent +
        ...
        >
          ...
          <div className="flex h-1/6  justify-around">
            <img className={logoStyle} onClick={handleLogoClick} src={maillogo} alt="Mail Logo" />
            <img className={logoStyle} onClick={handleLogoClick} src={facebook} alt="Facebook Logo" />
            <img className={logoStyle} onClick={handleLogoClick} src={x} alt="X (Twitter) Logo" />
            <img className={logoStyle} onClick={handleLogoClick} src={ig} alt="Instagram Logo" />
          </div>
         </div> 
      </div>
    </>
